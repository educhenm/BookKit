...
(function($) {
 $.fn.collidesWith = function(elements, rotated) {
  ...
  rects.each(function() {            
   var rect = $(this);
    ...
    var rectOff = undefined; 
    var rectMinX = undefined;
    var rectMinY = undefined;
    var rectMaxX = undefined;
    var rectMaxY = undefined;

   // define minimum and maximum coordinates
   if (rotated) {
    var rectOff = rect.offset(); 
    var rectMinX = rectOff.top;
    var rectMinY = rectOff.left;
    var rectMaxX = rectMinX + rect.outerHeight();
    var rectMaxY = rectMinY + rect.outerWidth();
   } else {
     var rectOff = rect.offset();
   ...
   checkWith.not(rect).each(function() {
    ...
    if (rotated) {
      ...
      var otherRectMinX = otherRectOff.top;
      var otherRectMinY = otherRectOff.left;
      var otherRectMaxX = otherRectMinX + otherRect.outerHeight();
      var otherRectMaxY = otherRectMinY + otherRect.outerWidth();
    } else {
      var otherRectOff = otherRect.offset();
